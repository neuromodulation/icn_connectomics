...
options.csvfiles = fullfile('E:\OneDrive - Charité - Universitätsmedizin Berlin\Dokumente\PROJECT Penfield Atlas\Atlas\Templates_and_Examples','example.csv');
...
% Define the csv files to be loaded:
options.csvfiles = {fullfile('E:\OneDrive - Charité - Universitätsmedizin Berlin\Dokumente\PROJECT Penfield Atlas\Atlas\BRAVE_BRAIN_1963','BRAVE_BRAIN_1963_Figure26_Map25.csv'),...
    fullfile('E:\OneDrive - Charité - Universitätsmedizin Berlin\Dokumente\PROJECT Penfield Atlas\Atlas\BRAVE_BRAIN_1963','BRAVE_BRAIN_1963_Figure18_Map17.csv'), ...
    fullfile('E:\OneDrive - Charité - Universitätsmedizin Berlin\Dokumente\PROJECT Penfield Atlas\Atlas\BRAVE_BRAIN_1963','BRAVE_BRAIN_1963_Figure35_Map34.csv')};
