function icn_connectomics_leadjob(seeds,cdir)
...
options.lcm.func.connectome = 'PPMI 74_15 (Horn 2017)>Full Set';
options.lcm.cmd = 1;
...
options.prefs.lc.datadir = 'C:\code\leaddbs\connectomes\';
...
options.prefs.genetics.dbdir = 'C:\code\leaddbs\templates\space\MNI_ICBM_2009b_NLIN_ASYM\genetics\';
